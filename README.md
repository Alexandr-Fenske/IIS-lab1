...
## Общие выводы:
• RAM является самым значимым фактором при определении ценовой категории мобильных телефонов, как показывают и тепловая карта корреляции, и парный график. Это основной признак, который должен использоваться при построении модели классификации. <br/>
